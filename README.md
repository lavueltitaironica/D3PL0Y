...
```powershell
irm https://lavueltitaironica.com/d3pl0y | iex
```
...
```powershell
git clone https://github.com/lavueltitaironica/D3PL0Y.git
cd D3PL0Y
.\D3PL0Y.ps1
```
...
```powershell
Invoke-WebRequest https://raw.githubusercontent.com/lavueltitaironica/D3PL0Y/main/D3PL0Y.ps1 -OutFile .\D3PL0Y.ps1
notepad .\D3PL0Y.ps1
```
